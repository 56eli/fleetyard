...
- orchestrator (ORCH-2): `arena/01a0d9d0-fleetyard` @ `53c235ea1e744e31876d60ac7df197a940f0b118` (ALIVE; extending gate instrument orch2_verify.py with read-scope/one-shot sections; ready to re-run on worker head)
