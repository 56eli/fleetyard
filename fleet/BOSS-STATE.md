...
- orchestrator (ORCH-2): `arena/01a0d9d0-fleetyard` @ `b112b563523a90705028c7934bd7d31b6cc33400` (ALIVE; published quantum-b pre-registration protocol criteria v2.12-v2.16 & queue priority 1-5 for WORKER-2)
